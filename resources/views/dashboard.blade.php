                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between mb-4">
                                        <a href="tel:{{$u->telefone_fixo}}" class="fw-light text-danger">{{"(".substr($u->telefone_fixo,0,2).") ".substr($u->telefone_fixo,2,-4)."-".substr($u->telefone_fixo,-4)}}</a>
                                        <a href="tel:{{$u->telefone_fixo}}" class="fw-light text-danger">{{"(".substr($u->telefone_celular,0,2).") ".substr($u->telefone_celular,2,-4)."-".substr($u->telefone_celular,-4)}}</a>
                                    </div>
                                </div>
